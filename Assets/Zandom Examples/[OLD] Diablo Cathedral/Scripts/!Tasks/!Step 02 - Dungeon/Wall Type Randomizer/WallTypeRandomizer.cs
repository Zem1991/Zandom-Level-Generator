...
//    {
//        public WallTypeRandomizer(ZandomLevelGenerator levelGenerator) : base(levelGenerator)
//        {
//        }
...
//                bool tooDistant = distance >= ZandomLevelGenerator.ZandomParameters.distantNeighborAgeMin;
...
//                foreach (Wall wall in ZandomLevelGenerator.Level.Walls.Values)
//                {
//                    yield return new GenerateFinalTiles(ZandomLevelGenerator, wall).Run();
//                }
//            }
//        }
...
//        {
//            WallTypePicker picker = new(ZandomLevelGenerator);
