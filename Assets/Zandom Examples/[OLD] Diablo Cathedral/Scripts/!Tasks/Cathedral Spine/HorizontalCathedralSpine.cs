...
//    {
//        public HorizontalCathedralSpine(ZandomLevelGenerator levelGenerator, int firstRoomPosition, int corridorLength) : base(levelGenerator, firstRoomPosition, corridorLength)
//        {
//        }
