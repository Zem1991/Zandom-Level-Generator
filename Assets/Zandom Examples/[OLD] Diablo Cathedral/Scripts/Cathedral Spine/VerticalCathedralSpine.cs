...
//    {
//        public VerticalCathedralSpine(ZandomLevelGenerator levelGenerator, int firstRoomPosition, int corridorLength) : base(levelGenerator, firstRoomPosition, corridorLength)
//        {
//            rotate = true;
//        }
